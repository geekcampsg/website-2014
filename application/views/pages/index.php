<div class="span7">
  ...
  <p class="subtitle">No startup talks. No how to get rich talks. This is a purely tech conference.</p> 
    ...
    <tbody>
      ...
      <tr>
        <td>
          ...
          <?php echo site_url('pages/index/'.$talk['year'].'/'.$talk['title'].'/'.$talk['speaker_name'].'#'.$talk['year'].'-'.$talk['title'].'-'.$talk['speaker_name'])?>
...
<div class="span5">
  ...
  <a href="http://hackerspace.sg">Hackerspace Image here</a>
  <a href="http://hackerspace.sg">PHP Meetup Image here</a>
  <a href="http://hackerspace.sg">PUG Image here</a>
  <a href="http://hackerspace.sg">RB Image here</a>
