<div class="span12">
    <div class="padded-element">
        ...
        <?php $url = urlencode(site_url('pages/index/'.date('Y').'/'.preg_replace("/[^a-zA-Z0-9]/", "", htmlspecialchars(set_value('title'))).'/'.preg_replace("/[^a-zA-Z0-9]/", "", htmlspecialchars(set_value('speaker-name'))).'#'.preg_replace("/[^a-zA-Z0-9]/", "", date('Y').'-'.htmlspecialchars(set_value('title')).'-'.htmlspecialchars(set_value('speaker-name'))))); ?>
